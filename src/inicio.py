...
contrasenaEntry=Entry(frame1, textvariable=contrasenaUsuario, font=("Arial", 12))
...
botonAceptar=Button(frame2, text="Aceptar", font=("Arial", 10))
botonAceptar.grid(column=0, row=0, padx=5, pady=10)


botonRegistro=Button(frame2, text="Registro", font=("Arial", 10))
